...
local markerGroupsPlugins = { Gh 'nvim-lua/plenary.nvim', Gh 'ibhagwan/fzf-lua', Gh 'folke/snacks.nvim', Gh 'nvim-telescope/telescope.nvim' }
vim.pack.add(markerGroupsPlugins)

vim.pack.add { Gh 'jameswolensky/marker-groups.nvim' }
require('marker-groups').setup {
  picker = 'snacks',
}
